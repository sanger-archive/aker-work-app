...
CREATE FUNCTION que_validate_tags(tags_array jsonb) RETURNS boolean
    LANGUAGE sql
    AS $$
  SELECT bool_and(
...
END) <= 200)),
    ...
    CONSTRAINT valid_data CHECK (((jsonb_typeof(data) = 'object'::text) AND ((NOT (data ? 'tags'::text)) OR ((jsonb_typeof((data -> 'tags'::text)) = 'array'::text) AND (jsonb_array_length((data -> 'tags'::text)) <= 5) AND que_validate_tags((data -> 'tags'::text))))))
)
WITH (fillfactor='90');
...
--
-- Name: que_determine_job_state(que_jobs); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION que_determine_job_state(job que_jobs) RETURNS text
    LANGUAGE sql
    AS $$
  SELECT
    CASE
...
CREATE FUNCTION que_job_notify() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
  DECLARE
    locker_pid integer;
...
CREATE FUNCTION que_state_notify() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
  DECLARE
    row record;
...
CREATE TABLE aker_process_module_pairings (
    id integer NOT NULL,
...
CREATE SEQUENCE aker_process_module_pairings_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE aker_process_module_pairings_id_seq OWNED BY aker_process_module_pairings.id;
...
CREATE TABLE aker_process_modules (
    id integer NOT NULL,
...
CREATE SEQUENCE aker_process_modules_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE aker_process_modules_id_seq OWNED BY aker_process_modules.id;
...
CREATE SEQUENCE aker_processes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE aker_processes_id_seq OWNED BY aker_processes.id;
...
CREATE TABLE aker_product_processes (
    id integer NOT NULL,
    product_id integer,
    aker_process_id integer,
...
CREATE SEQUENCE aker_product_processes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE aker_product_processes_id_seq OWNED BY aker_product_processes.id;
...
CREATE TABLE data_release_strategies (
...
CREATE TABLE process_module_choices (
    id bigint NOT NULL,
...
CREATE SEQUENCE process_module_choices_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE process_module_choices_id_seq OWNED BY process_module_choices.id;
...
CREATE SEQUENCE que_jobs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE que_jobs_id_seq OWNED BY que_jobs.id;
...
CREATE TABLE work_order_module_choices (
    id integer NOT NULL,
...
CREATE SEQUENCE work_order_module_choices_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE work_order_module_choices_id_seq OWNED BY work_order_module_choices.id;
...
ALTER TABLE ONLY aker_process_module_pairings ALTER COLUMN id SET DEFAULT nextval('aker_process_module_pairings_id_seq'::regclass);
...
ALTER TABLE ONLY aker_process_modules ALTER COLUMN id SET DEFAULT nextval('aker_process_modules_id_seq'::regclass);
...
ALTER TABLE ONLY aker_processes ALTER COLUMN id SET DEFAULT nextval('aker_processes_id_seq'::regclass);
...
ALTER TABLE ONLY aker_product_processes ALTER COLUMN id SET DEFAULT nextval('aker_product_processes_id_seq'::regclass);
...
ALTER TABLE ONLY process_module_choices ALTER COLUMN id SET DEFAULT nextval('process_module_choices_id_seq'::regclass);
...
ALTER TABLE ONLY que_jobs ALTER COLUMN id SET DEFAULT nextval('que_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY work_order_module_choices ALTER COLUMN id SET DEFAULT nextval('work_order_module_choices_id_seq'::regclass);
...
ALTER TABLE ONLY aker_process_module_pairings
...
ALTER TABLE ONLY aker_process_modules
...
ALTER TABLE ONLY aker_processes
...
ALTER TABLE ONLY aker_product_processes
...
ALTER TABLE ONLY data_release_strategies
...
ALTER TABLE ONLY process_module_choices
...
ALTER TABLE ONLY work_order_module_choices
...
CREATE INDEX index_aker_process_module_pairings_on_aker_process_id ON aker_process_module_pairings USING btree (aker_process_id);
...
CREATE INDEX index_aker_process_module_pairings_on_from_step_id ON aker_process_module_pairings USING btree (from_step_id);
...
CREATE INDEX index_aker_process_module_pairings_on_to_step_id ON aker_process_module_pairings USING btree (to_step_id);
...
CREATE INDEX index_aker_process_modules_on_aker_process_id ON aker_process_modules USING btree (aker_process_id);
...
CREATE UNIQUE INDEX index_aker_process_modules_on_aker_process_id_and_name ON aker_process_modules USING btree (aker_process_id, name);
...
CREATE INDEX index_aker_product_processes_on_aker_process_id ON aker_product_processes USING btree (aker_process_id);
...
CREATE INDEX index_aker_product_processes_on_product_id ON aker_product_processes USING btree (product_id);
...
CREATE INDEX index_catalogues_on_lims_id ON catalogues USING btree (lims_id);
...
CREATE UNIQUE INDEX index_data_release_strategies_on_id ON data_release_strategies USING btree (id);
...
CREATE INDEX index_jobs_on_work_order_id ON jobs USING btree (work_order_id);
...
CREATE UNIQUE INDEX index_on_aker_pairings ON aker_process_module_pairings USING btree (from_step_id, to_step_id, aker_process_id);
...
CREATE INDEX index_permissions_on_accessible_type_and_accessible_id ON permissions USING btree (accessible_type, accessible_id);
...
CREATE INDEX index_permissions_on_permitted ON permissions USING btree (permitted);
...
CREATE UNIQUE INDEX index_permissions_on_various ON permissions USING btree (permitted, permission_type, accessible_id, accessible_type);
...
CREATE INDEX index_process_module_choices_on_aker_process_id ON process_module_choices USING btree (aker_process_id);
...
CREATE INDEX index_process_module_choices_on_aker_process_module_id ON process_module_choices USING btree (aker_process_module_id);
...
CREATE INDEX index_process_module_choices_on_work_plan_id ON process_module_choices USING btree (work_plan_id);
...
CREATE INDEX index_products_on_catalogue_id ON products USING btree (catalogue_id);
...
CREATE INDEX index_work_order_module_choices_on_aker_process_modules_id ON work_order_module_choices USING btree (aker_process_modules_id);
...
CREATE INDEX index_work_order_module_choices_on_work_order_id ON work_order_module_choices USING btree (work_order_id);
...
CREATE INDEX index_work_orders_on_process_id ON work_orders USING btree (process_id);
...
CREATE INDEX index_work_orders_on_work_plan_id ON work_orders USING btree (work_plan_id);
...
CREATE INDEX index_work_plans_on_data_release_strategy_id ON work_plans USING btree (data_release_strategy_id);
...
CREATE INDEX index_work_plans_on_owner_email ON work_plans USING btree (owner_email);
...
CREATE INDEX index_work_plans_on_product_id ON work_plans USING btree (product_id);
...
CREATE INDEX que_poll_idx ON que_jobs USING btree (queue, priority, run_at, id) WHERE ((finished_at IS NULL) AND (expired_at IS NULL));
...
CREATE TRIGGER que_job_notify AFTER INSERT ON que_jobs FOR EACH ROW EXECUTE PROCEDURE que_job_notify();
...
CREATE TRIGGER que_state_notify AFTER INSERT OR DELETE OR UPDATE ON que_jobs FOR EACH ROW EXECUTE PROCEDURE que_state_notify();
...
ALTER TABLE ONLY process_module_choices
    ADD CONSTRAINT fk_rails_195798c85f FOREIGN KEY (aker_process_id) REFERENCES aker_processes(id);
...
ALTER TABLE ONLY work_order_module_choices
    ADD CONSTRAINT fk_rails_42b0ef90a2 FOREIGN KEY (work_order_id) REFERENCES work_orders(id);
...
ALTER TABLE ONLY work_order_module_choices
    ADD CONSTRAINT fk_rails_4568d52d49 FOREIGN KEY (aker_process_modules_id) REFERENCES aker_process_modules(id);
...
ALTER TABLE ONLY process_module_choices
    ADD CONSTRAINT fk_rails_4a4bc501a8 FOREIGN KEY (work_plan_id) REFERENCES work_plans(id);
...
ALTER TABLE ONLY work_orders
    ADD CONSTRAINT fk_rails_620904daa7 FOREIGN KEY (work_plan_id) REFERENCES work_plans(id);
...
ALTER TABLE ONLY aker_process_modules
    ADD CONSTRAINT fk_rails_70ee2c6156 FOREIGN KEY (aker_process_id) REFERENCES aker_processes(id);
...
ALTER TABLE ONLY work_plans
    ADD CONSTRAINT fk_rails_726b127a48 FOREIGN KEY (product_id) REFERENCES products(id);
...
ALTER TABLE ONLY aker_product_processes
    ADD CONSTRAINT fk_rails_7af98dbc24 FOREIGN KEY (aker_process_id) REFERENCES aker_processes(id);
...
ALTER TABLE ONLY work_orders
    ADD CONSTRAINT fk_rails_837dcc1d05 FOREIGN KEY (process_id) REFERENCES aker_processes(id);
...
ALTER TABLE ONLY jobs
    ADD CONSTRAINT fk_rails_8b401b6695 FOREIGN KEY (work_order_id) REFERENCES work_orders(id);
...
ALTER TABLE ONLY products
    ADD CONSTRAINT fk_rails_a75fcac2cc FOREIGN KEY (catalogue_id) REFERENCES catalogues(id);
...
ALTER TABLE ONLY work_plans
    ADD CONSTRAINT fk_rails_aa13f61d0b FOREIGN KEY (data_release_strategy_id) REFERENCES data_release_strategies(id);
...
ALTER TABLE ONLY aker_product_processes
    ADD CONSTRAINT fk_rails_ad31b9e5d1 FOREIGN KEY (product_id) REFERENCES products(id);
...
ALTER TABLE ONLY process_module_choices
    ADD CONSTRAINT fk_rails_be1fa10a0a FOREIGN KEY (aker_process_module_id) REFERENCES aker_process_modules(id);

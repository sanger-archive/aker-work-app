...
RSpec.describe 'WorkOrderSplitter' do
  ...
  before :each do
    ...
    stub_request(:patch, "http://external-server:3000/api/v1/sets/28d7c0e2-9935-41b1-a806-e9b22324d41f")
      .with(body: "{\"data\":{\"id\":\"28d7c0e2-9935-41b1-a806-e9b22324d41f\",\"type\":\"sets\",\"attributes\":{\"owner_id\":\"aker@sanger.ac.uk\",\"locked\":true}}}")
      .to_return(status: 200, body: "", headers: {})

    stub_request(:patch, "http://external-server:3000/api/v1/sets/28d7c0e2-9935-41b1-a806-e9b22324d42d")
      .with(body: "{\"data\":{\"id\":\"28d7c0e2-9935-41b1-a806-e9b22324d42d\",\"type\":\"sets\",\"attributes\":{\"owner_id\":\"aker@sanger.ac.uk\",\"locked\":true}}}")
      .to_return(status: 200, body: "", headers: {})

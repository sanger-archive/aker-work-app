...
var baseSetToString = __webpack_require__(114),
    shortOut = __webpack_require__(116);
...
var _product_description = __webpack_require__(75);

var _webpackerReact = __webpack_require__(76);
...
exports.ProcessModuleParameters = exports.WorkOrderProcess = exports.ProductDescription = undefined;
  ...
  _createClass(Processes, [{
    ...
    value: function render() {
      ...
      function makeProcess(process, index) {
        var pro = { links: process.links, path: process.path, name: process.name,
...
var ProcessNameLabel = function (_React$Component10) {
  ...
  _createClass(ProcessNameLabel, [{
    key: 'render',
    value: function render() {
      var text = this.props.name ? _react2.default.createElement(
        'h5',
        null,
        this.props.name
      ) : _react2.default.createElement(
  ...
  _createClass(ProcessModulesSelectDropdowns, [{
    ...
    value: function render() {
      ...
      path.forEach(function (obj, index) {
        ...
        select_dropdowns.push(_react2.default.createElement(ProcessModuleSelectElement, { selected: selected, selectedValueForChoice: obj.selected_value, options: options, key: index, id: index, onChange: _this12.props.onChange, enabled: _this12.props.enabled }));
      });
...
var ProcessModuleParameters = exports.ProcessModuleParameters = function (_React$Component12) {
  _inherits(ProcessModuleParameters, _React$Component12);

  function ProcessModuleParameters(props) {
    _classCallCheck(this, ProcessModuleParameters);

    var _this13 = _possibleConstructorReturn(this, (ProcessModuleParameters.__proto__ || Object.getPrototypeOf(ProcessModuleParameters)).call(this, props));

    _this13.validValue = _this13.validValue.bind(_this13);
    _this13.classes = _this13.classes.bind(_this13);
    _this13.onChange = _this13.onChange.bind(_this13);
    _this13.renderFeedback = _this13.renderFeedback.bind(_this13);
    _this13.state = {
      selectedValue: _this13.props.selectedValueForChoice || ""
    };
    return _this13;
  }

  _createClass(ProcessModuleParameters, [{
    key: 'validValue',
    value: function validValue() {
      return this.state.selectedValue >= this.props.selectedOption.min_value && this.state.selectedValue <= this.props.selectedOption.max_value;
    }
  }, {
    key: 'onChange',
    ...
    key: 'renderFeedback',
    value: function renderFeedback(caption) {
    ...
    value: function render() {
      if (this.props.selectedOption.min_value || this.props.selectedOption.max_value) {
        var caption = "Enter value between " + this.props.selectedOption.min_value + " and " + this.props.selectedOption.max_value;
        var name = "work_plan[work_order_module][" + this.props.selectedOption.id + "][selected_value]";
        return _react2.default.createElement(
          'div',
          { className: this.classes() },
          _react2.default.createElement('input', { autoComplete: 'off', value: this.state.selectedValue, type: 'text', name: name, className: 'form-control', placeholder: caption, onChange: this.onChange }),
  ...
  return ProcessModuleParameters;
}(_react2.default.Component);

var ProcessModuleSelectElement = function (_React$Component13) {
  _inherits(ProcessModuleSelectElement, _React$Component13);

  function ProcessModuleSelectElement(props) {
    _classCallCheck(this, ProcessModuleSelectElement);

    var _this14 = _possibleConstructorReturn(this, (ProcessModuleSelectElement.__proto__ || Object.getPrototypeOf(ProcessModuleSelectElement)).call(this, props));

    _this14.renderSelect = _this14.renderSelect.bind(_this14);
    return _this14;
  }

  _createClass(ProcessModuleSelectElement, [{
    key: 'renderSelect',
    value: function renderSelect(select_options, selection) {
      if (this.props.enabled) {
        return _react2.default.createElement(
          'select',
    ...
    value: function render() {
      ...
      var selectedOption = this.props.options.filter(function (opt) {
        return opt.id == selection;
      })[0];
      return _react2.default.createElement(
        'div',
        { className: 'row' },
        ...
        _react2.default.createElement(ProcessModuleParameters, { selectedOption: selectedOption, selectedValueForChoice: this.props.selectedValueForChoice })
      );
    }
  }]);
...
var ProcessModuleSelectOption = function (_React$Component14) {
  _inherits(ProcessModuleSelectOption, _React$Component14);
...
var ProductInformation = function (_React$Component15) {
  _inherits(ProductInformation, _React$Component15);
...
var CostInformation = function (_React$Component16) {
  _inherits(CostInformation, _React$Component16);
...
var _omit = __webpack_require__(129);

var _omit2 = _interopRequireDefault(_omit);

var _ujs = __webpack_require__(182);
...
var arrayMap = __webpack_require__(12),
    baseIntersection = __webpack_require__(78),
...
var arrayMap = __webpack_require__(12),
    ...
    baseUnset = __webpack_require__(165),
    castPath = __webpack_require__(33),
    copyObject = __webpack_require__(6),
    customOmitClone = __webpack_require__(176),
